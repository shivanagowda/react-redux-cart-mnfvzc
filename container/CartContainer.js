          ...
          <Modal.Body>
            ...
            <Col sm={6}>
              <Col sm={6}> 
                ...
                {
                  this.state.productData && <ul className="list-styles"><li ><label for="sel1">Colors:</label></li>
                    {
                      this.state.modalShow &&
                      this.state.productData.p_available_options.colors.map((colorList) => {
                        return <li title={colorList.name} className="list-styles" ><span onClick={() => this.getColor([colorList.name, colorList.hexcode])} className="colors-style" style={{backgroundColor: colorList.hexcode}}></span></li>
                      })
                    }
                  </ul>
                }
                {
                  this.state.productData && <ul className="list-styles"><li ><label for="sel1">Sizes:</label></li>
              ...
              <Col sm={6}>
              <img className="img-style" src={this.state.productData.p_image} alt={this.state.productData.p_name} />
              </Col>
              </Col>
            </Row>
            </Grid>  
